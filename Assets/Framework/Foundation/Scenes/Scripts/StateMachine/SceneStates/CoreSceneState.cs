...
namespace Framework.Foundation.Scenes.StateMachine.SceneStates
{
    public class CoreSceneState : ISceneState
    {
        ...
        public CoreSceneState(ISceneService sceneService, IAudioController audioController, ILogChannel logger)
        {
        ...
        public void Enter()
        {
            _sceneService.LoadScene(SceneConstants.Scenes.Core, OnLoaded);
